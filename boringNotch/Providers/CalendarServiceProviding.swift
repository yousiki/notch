...
class CalendarService: CalendarServiceProviding, @unchecked Sendable {
...
extension EKCalendar {
    ...
    fileprivate var isDelegate: Bool {
        source.isDelegate
    }
}

extension EKEvent {
    fileprivate var currentUser: EKParticipant? {
        attendees?.first(where: \.isCurrentUser)
    }

    fileprivate var shouldBeAllDay: Bool {
