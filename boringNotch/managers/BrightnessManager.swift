...
final class BrightnessManager: ObservableObject, @unchecked Sendable {
    nonisolated(unsafe) static let shared = BrightnessManager()
...
final class KeyboardBacklightManager: ObservableObject, @unchecked Sendable {
    nonisolated(unsafe) static let shared = KeyboardBacklightManager()
